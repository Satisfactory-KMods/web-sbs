...
const ZodBlueprintSchema = ZodBlueprintBase.merge(
	z.object({
...
const MongoBlueprints = mongoose.model<BlueprintData, mongoose.Model<BlueprintData, unknown, BlueprintSchemaMethods>>(
	'SBS_Blueprints',
	BlueprintSchema
);
...
const MongoBlueprintPacks = mongoose.model<BlueprintPack, mongoose.Model<BlueprintPack, unknown, BlueprintPackSchemaMethods>>(
	'SBS_BlueprintPacks',
	BlueprintPackSchema
);
