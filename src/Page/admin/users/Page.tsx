	...
	return (
		<div className='flex flex-col'>
			<div className='w-full rounded-lg border border-gray-200 bg-white shadow dark:border-gray-700 dark:bg-gray-800'>
				<div className='rounded-t-lg border-b border-gray-600 bg-gray-700 p-3 text-2xl font-semibold text-neutral-300'>Admin: Users</div>
			</div>
			...
			<div className='mt-2'>
				<Table striped={true}>
					...
					<Table.Body>
						{data.map((tag) => (
							<UserRow key={tag._id} data={tag} doFetch={doFetch} />
						))}
					</Table.Body>
				</Table>
			</div>
